...
💡 사용자 경험을 최우선으로 생각하며 서비스를 설계하고 구현하는 프론트엔드 개발자를 목표로 하고 있습니다.

실제 서비스를 기획부터 개발, 배포까지 직접 진행하며 Vercel을 통해 운영 경험을 쌓았습니다.
또한 Google Search Console과 네이버 서치어드바이저를 활용하여 SEO를 적용하고 검색 노출을 개선한 경험이 있습니다.

AI 도구를 적극적으로 활용하여 개발 생산성을 높이고, 기획 의도를 정확히 반영한 UI를 구현하는 것을 중요하게 생각합니다.
특히 사용자 관점에서 직관적이고 사용하기 쉬운 인터페이스를 만드는 데 집중하고 있습니다.
